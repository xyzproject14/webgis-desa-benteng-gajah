...
<html>
  ...
  <body>
    ...
    <button class="w-max btn btn-primary" id="btn-sidebar" onclick="showSidebar()">OPEN SIDEBAR</button>
    <div
      class="sidebar transition fixed top-0 bottom-0 lg:left-0 p-2 w-[300px] overflow-y-auto text-center bg-gray-900 my-sidebar"
    >
    ...
    <script type="text/javascript">
      ...
      function showSidebar(){
        document.querySelector('.sidebar').classList.toggle('my-sidebar')
      }
    </script>
  </body>
</html>